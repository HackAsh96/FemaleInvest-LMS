...
const ListCommunityPostsUsecase_1 = require("./core/usecases/ListCommunityPosts/ListCommunityPostsUsecase");
...
const listCommunityPostsUsecase = new ListCommunityPostsUsecase_1.ListCommunityPostsUsecase(mockRepos.communityPosts);
...
app.get("/community", (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const communityPosts = yield listCommunityPostsUsecase.exec();
    return res.send(communityPosts);
}));
app.listen(port, () => {
