...
import { ListCommunityPostsUsecase } from "./core/usecases/ListCommunityPosts/ListCommunityPostsUsecase";
...
const listCommunityPostsUsecase = new ListCommunityPostsUsecase(mockRepos.communityPosts)
...
app.get("/community", async (_req: Request, res: Response) => {
const communityPosts = await listCommunityPostsUsecase.exec()
